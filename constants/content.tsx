...
export const MAIN_CONTENT: { left: JSX.Element; right: JSX.Element }[] = [
  {
    ...
    right: (
      <div className='grid gap-5'>
        <p>
          As a software engineer, I have a proven track record of delivering apps to live
          users across the globe. I am passionate about problem-solving and derive
          satisfaction from providing innovative solutions to real-world issues. My
          unwavering commitment to continuous learning and adaptability guarantees
          exceptional results for every project, ensuring that the applications I create
          not only meet but exceed users&apos;s expectations.
        </p>
